...
public class Linked_list<T> {
    ...
    int isThere(Queuell<Integer> queue){
        int i = 0;
        Node<Integer> tmp1 = (Node<Integer>) queue.head;
        Node<Integer> tmp2 = (Node<Integer>) this.first;
        while(tmp2 != null){
            while(tmp1 != null){
